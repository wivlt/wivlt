...
group :development, :test do
  ...
  gem "rubocop", "~> 1.75", require: false # Static code analyzer and formatter based on the Ruby style guide
  gem "simplecov", "~> 0.22.0", require: false # Code coverage analysis tool for Ruby
end
